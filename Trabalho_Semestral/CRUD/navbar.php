                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="#inicio"><i
                                    class="bi bi-info-circle-fill me-1"></i>Início</a></li>
                        <li class="nav-item"><a class="nav-link" href="#equipe"><i
                                    class="bi bi-people-fill me-1"></i>Equipe</a></li>
                        <li class="nav-item"><a class="nav-link" href="#servicos"><i
                                    class="bi bi-tools me-1"></i>Serviços</a></li>
                        <li class="nav-item"><a class="nav-link" href="#horarios"><i
                                    class="bi bi-calendar me-1"></i>Horários</a></li>
                        <li class="nav-item"><a class="nav-link" href="#agendar"><i
                                    class="bi bi-calendar3 me-1"></i>Agendamento</a></li>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop"><i
                                                class="bi bi-arrow-clockwise me-1"></i>Redefinir Senha</a></li>
                                    <li><a class="dropdown-item" href="#"
                                            onclick="confirmarExclusaoConta()"><i
                                                class="bi bi-trash me-1"></i>Excluir Conta</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="#"
                                            onclick="confirmarSairConta()"><i
                    ...
                    <form id="formRedefinirSenha" method="POST" action="verify/redefinirSenha.php">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="mostrarNovaSenha"
                                    onclick="mostrarSenha('novaSenha')">Mostrar Senha</button>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="mostrarConfirmarSenha"
                                    onclick="mostrarSenha('confirmarSenha')">Mostrar Senha</button>
                            </div>
                        </div>
